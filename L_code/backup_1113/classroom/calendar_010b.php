...
<head>
    ...
    <title>萬年曆</title>
    <!-- <link rel="stylesheet" href="./calendar_010b.css"> -->
    <style>
        * {
            margin: 0;
        }
        ...
        body {
            background-image: url('./bg-calendar-4.jpg');
        }
        ...
        .container {
            ...
            background-image: url('./bg-calendar-3.jpg');
        }
        ...
        .aside {
            ...
            flex-direction: column;
            font-family: '標楷體';
            background-image: url("./bg-calendar-5.jpg");
        }
...
<body>
    ...
    ?>
<div class="bg-contaier" <?php echo 'style="background-image: url(./'.$thisMonth.'.jpg");' ?>>
    <header class="top">
        萬年曆
    </header>
    <div class="container">
